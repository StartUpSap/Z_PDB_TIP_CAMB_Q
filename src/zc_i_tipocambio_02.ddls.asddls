...
@EndUserText.label: 'Tipo de Cambio con Parámetros'
...
define view entity ZC_I_TIPOCAMBIO_02 
with parameters
    ...
    on '5710' = I_CompanyCode.CompanyCode
{
    ...
    cast( round( I_ExchangeRateRawData.ExchangeRate, 3 ) as abap.decfloat34 ) as ExchangeRate_3Decimals,
    ...
    cast( round( I_ExchangeRateRawData.ExchangeRate, 3 ) as abap.char(100) ) as ExchangeRate_3Decimals_Text,
